 ...
 * 
 */
public class RegionesFragment extends ListFragment {
	...
	public void onResume() {		
		super.onResume();
		this.tracker.set(Fields.SCREEN_NAME, "Regiones");
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {	
		...
		try {
			...
			Log.d(Global.TAG,"Fragment Regiones - Adaptador inflado OK");
		} catch (Exception e) {
			Log.e(Global.TAG,"Fragment Regiones - Error en adaptador "+e);
		}
	}
