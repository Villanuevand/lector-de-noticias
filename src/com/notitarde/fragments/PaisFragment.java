 ...
 * 
 */
public class PaisFragment extends ListFragment {
	...
	public void onResume() {		
		super.onResume();
		this.tracker.set(Fields.SCREEN_NAME, "País");
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		super.onViewCreated(view, savedInstanceState);	
			try {
				...
				Log.d(Global.TAG,"Fragment Pais - Adaptador inflado OK");
			} catch (Exception e) {
				Log.e(Global.TAG,"Fragment Pais - Error al inflar adaptador "+e);
			}
	}
