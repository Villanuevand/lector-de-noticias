 ...
 * 
 */
public class EconomiaFragment extends ListFragment {
	...
	public void onResume() {		
		super.onResume();
		this.tracker.set(Fields.SCREEN_NAME, "Economía");
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		super.onViewCreated(view, savedInstanceState);
			try {
				...
				Log.d(Global.TAG,"Fragment Economia - Adaptador inflado OK");
			} catch (Exception e) {
				Log.e(Global.TAG,"Fragment Economia - Error al inflar adaptador "+e);
			}
