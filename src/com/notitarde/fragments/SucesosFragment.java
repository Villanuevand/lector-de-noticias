 ...
 * 
 */
public class SucesosFragment extends ListFragment {
	...
	public void onResume() {		
		super.onResume();
		this.tracker.set(Fields.SCREEN_NAME, "Sucesos");
	...
	public void onViewCreated(View view, Bundle savedInstanceState) { 
		...
		try {
			...
			Log.d(Global.TAG,"Fragment Sucesos - Adaptador inflado OK");
		} catch (Exception e) {
			Log.e(Global.TAG,"Fragment Sucesos - Error al inflar adaptador "+e);
		}		
	}
