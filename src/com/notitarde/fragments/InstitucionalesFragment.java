 ...
 * 
 */
public class InstitucionalesFragment extends ListFragment {

	NoticiasAdapter nAdapter;
	private Tracker tracker;
	
	public InstitucionalesFragment() {
	...
	public void onResume() {		
		super.onResume();
		this.tracker.set(Fields.SCREEN_NAME, "Institucionales");
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		try {
			...
			Log.d(Global.TAG,"Fragment Institucionales - Adaptador inflado OK");
		} catch (Exception e) {
			Log.e(Global.TAG,"Fragment Institucionales - Error al inflar adaptador "+e);
		}
	}
